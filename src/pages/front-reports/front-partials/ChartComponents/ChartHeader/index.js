...
class ChartHeader extends React.Component {
  ...
  */
  componentDidUpdate(prevProps) {
    ...
    const {chartTypes,groubByButtons, tabActive ,changeView} = this.props;
    const {chartTypes:prevTypes,groubByButtons:prevButtons, tabActive:previousTab, 
      changeView:prevChangeView } = prevProps;
